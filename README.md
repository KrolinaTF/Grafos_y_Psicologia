...
Experimentación con grafos en un análisis de datos psicológicos. Repositorio de aprendizaje. 
...
Publicado en Scientific Data (Nature)

24.292 estudiantes universitarios  
Xinxiang Medical University  
Feb–Mar 2021

5 archivos CSV unidos por export_id 
- demographic.csv
- gad7.csv (ansiedad)
- isi.csv (insomnio) 
- phq9.csv (depresión)
- pss.csv (estrés percibido)
